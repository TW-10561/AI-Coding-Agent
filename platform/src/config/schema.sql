...
CREATE TABLE IF NOT EXISTS api_key_audit_log (
  ...
  action                  VARCHAR(30) NOT NULL CHECK (action IN ('created', 'rotated', 'revoked', 'validated', 'expired', 'admin_verified', 'admin_rejected')),
  ip_address              INET,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_workspaces_dir ON workspaces(directory);
